    ...
    <>
      <Row className="bg-bluegray_51 font-sourcesanspro items-center mx-[auto] w-[100%]">
        ...
        <Column className="items-center w-[93%]">
          ...
          <Row className="bg-gray_100 border border-indigo_50 border-solid items-center justify-start lg:pr-[626px] xl:pr-[717px] pr-[806px] 3xl:pr-[967px] w-[100%]">
          ...
          <Row className="items-center justify-evenly lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] lg:px-[12px] xl:px-[14px] px-[16px] 3xl:px-[19px] w-[100%]">
            ...
            <Column className="lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] w-[32%]">
              ...
              <Stack className="lg:h-[516px] xl:h-[590px] h-[663px] 2xl:h-[664px] 3xl:h-[797px] lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] w-[100%]">
                <Stack className="absolute lg:h-[516px] xl:h-[590px] h-[663px] 2xl:h-[664px] 3xl:h-[797px] inset-[0] w-[100%]">
                ...
                <Column className="absolute bottom-[7%] inset-x-[0] items-start justify-start mx-[auto] w-[92%]">
                  ...
                  <Column className="items-center lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] w-[100%]">
                    ...
                    <Row className="items-center justify-between lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] mx-[auto] w-[99%]">
                    ...
                    <Row className="items-center justify-between lg:mt-[38px] xl:mt-[44px] mt-[50px] 3xl:mt-[60px] mx-[auto] w-[99%]">
                  ...
                  <Column className="items-end lg:mt-[31px] xl:mt-[35px] mt-[40px] 3xl:mt-[48px] lg:pl-[38px] xl:pl-[44px] pl-[50px] 3xl:pl-[60px] w-[100%]">
                    <Line className="bg-red_700 h-[1px] w-[87%]" />
                  </Column>
                  <Column className="items-center 3xl:mt-[10px] lg:mt-[7px] xl:mt-[8px] mt-[9px] w-[100%]">
                    <Row className="items-center justify-between xl:pl-[1px] lg:pl-[1px] pl-[2px] w-[100%]">
                      ...
                      <Line className="bg-bluegray_100 h-[1px] lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] my-[11px] 3xl:my-[13px] lg:my-[8px] xl:my-[9px] w-[87%]" />
                    </Row>
                    <Row className="items-center justify-between lg:mt-[38px] xl:mt-[44px] mt-[50px] 3xl:mt-[60px] mx-[auto] w-[99%]">
