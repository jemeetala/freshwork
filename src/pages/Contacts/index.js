      ...
      <Row className="bg-bluegray_51 font-sourcesanspro items-center mx-[auto] w-[100%]">
        ...
        <Column className="items-center w-[93%]">
          ...
          <Row className="items-center justify-evenly w-[100%]">
            <Stack className="3xl:h-[1078px] lg:h-[698px] xl:h-[798px] h-[897px] 2xl:h-[898px] w-[24%]">
              <Stack className="absolute 3xl:h-[1078px] lg:h-[698px] xl:h-[798px] h-[897px] 2xl:h-[898px] inset-[0] w-[100%]">
              ...
              <Column className="absolute bottom-[1%] font-inter items-center justify-start left-[7%] w-[26%]">
                <CheckBox
            ...
            <Image
              ...
              className="3xl:h-[1078px] lg:h-[698px] xl:h-[798px] h-[897px] 2xl:h-[898px] object-contain w-[4%]"
              alt="Column"
            />
          </Row>
        </Column>
